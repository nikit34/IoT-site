...
<br>
                <div class="btn-group">
                  <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <button class="dropdown-item" type="button">average: 0.029</button>
                    <button class="dropdown-item" type="button">median: 0.032</button>
                    <button class="dropdown-item" type="button">max: 1.301</button>
                    <button class="dropdown-item" type="button">min: 0.000</button>
                  </div>
                </div>
          ...
          $('#datetimepicker10').datetimepicker({
            ...
            <thead>
              <tr>
                ...
                <th scope="col"> <div class="text-center">Vibration Sensor Data number 2</div></th>
              </tr>
            </thead>
          </table>
